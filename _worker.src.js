...
// 设置优选地址api接口
let addressesapi = [
	'https://raw.githubusercontent.com/ipx2001/lxp/main/addressesapii.txt', //可参考内容格式 自行搭建。
...
let addressesnotlsapi = [
	'https://raw.githubusercontent.com/ipx2001/lxp/main/addressesapii.txt',
];

let DLS = 8;//速度下限
let addressescsv = [
	//'https://raw.githubusercontent.com/ipx2001/lxp/main/tpe-IP.csv', //iptest测速结果文件。
];

let subconverter = "SUBAPI.CMLiussss.net"; //在线订阅转换后端，目前使用肥羊的订阅转换功能。支持自建psub 可自行搭建https://github.com/bulianglin/psub
